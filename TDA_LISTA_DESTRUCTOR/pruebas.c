...
void dadaunalistadetreselementos_alquererinsertarodenadamenteunelementoenunaposicioninexsitente_seinsertaenlaultimaposicion(){
	...
	int primer_elemento = 1, segundo_elemento = 2, tercer_elemento = 3, elemento_a_insertar = 4,otro_elemento = 5;
	int posicion_invalida = -5;

	if(lista != NULL){
		lista_insertar_en_posicion(lista, &(primer_elemento),0);
		lista_insertar_en_posicion(lista, &(segundo_elemento),1);
		lista_insertar_en_posicion(lista, &(tercer_elemento),2);
		lista_insertar_en_posicion(lista, &(elemento_a_insertar),(size_t)posicion_invalida);
		pa2m_afirmar(*(int*)lista_ultimo(lista) == 4,"El elemento se inserta en la ultima posicion al pasar una posicion mayor a la cantidad de elementos de la lista");
		lista_insertar_en_posicion(lista, &(otro_elemento), 10);
		pa2m_afirmar(*(int*)lista_ultimo(lista) == 5,"Otro elemento se inserta en la ultima posicion al pasar una posicion mayor a la cantidad de elementos de la lista");
...
void dadaunalistadetreselementos_alquererinsertarunelementoenunaposicioninexsitentealfinaldelalista_seinsertaenlaultimaposicion(){
	lista_t* lista = lista_crear();
	int primer_elemento = 1, segundo_elemento = 2, tercer_elemento = 3, elemento_a_insertar = 4,otro_elemento = 5;
	...
	if(lista != NULL){
		...
		lista_insertar(lista, &(segundo_elemento));
		lista_insertar(lista, &(tercer_elemento));
		lista_insertar_en_posicion(lista, &(elemento_a_insertar),66);
		pa2m_afirmar(*(int*)lista_ultimo(lista) == 4,"El elemento se inserta en la ultima posicion al pasar una posicion mayor a la cantidad de elementos de la lista tras insercion no ordenada");
		lista_insertar_en_posicion(lista, &(otro_elemento), 10);
		pa2m_afirmar(*(int*)lista_ultimo(lista) == 5,"Otro elemento se inserta en la ultima posicion al pasar una posicion mayor a la cantidad de elementos de la lista tras insercion no ordenada");
...
void dadaunalistavacia_alcrearunaiterador_secreauniterador(){
	...
	lista_iterador_t*  it  = lista_iterador_crear(lista_vacia);
  	pa2m_afirmar(it != NULL, "Puedo crear un iterador sobre una lista vacia");
...
/*
Devuelve false en caso de error (en caso de que tanto elemento a recorrer de la lista como el elemento buscado sean inexistentes )
...
*/
bool buscar_elemento_entero(void* elemento, void* elemento_buscado)
{
  ...
  if(*(int*)elemento == *(int*)elemento_buscado)
    recorrer = false;
...
void probar_iterador_interno_de_lista(){
	...
	pa2m_afirmar(lista_elemento_en_posicion(una_lista,0) == &(n_1) && lista_elemento_en_posicion(una_lista,1) == &(n_2) && lista_elemento_en_posicion(una_lista,2) == &(n_3),
		"Dada una lista vacia ser insertaron los elmentos : 10 , 20 y 30 respectivamente");

	size_t contador = 0, contador_aux = 0, contador_aux_2 = 0;

	pa2m_afirmar((1 == lista_con_cada_elemento(una_lista,funcion_2,&(contador))) && (2 == lista_con_cada_elemento(una_lista,funcion_3,&(contador_aux))) && (3 == lista_con_cada_elemento(una_lista,funcion_4,&(contador_aux_2))),"El iterador interno itera correctamente sobre los 3 elementos de la lista");
    
    pa2m_afirmar(1 == lista_con_cada_elemento(una_lista,buscar_elemento_entero,NULL),"El iterador no itera si el elemento a buscar es NULL");
   
    pa2m_afirmar(lista_con_cada_elemento(una_lista,buscar_elemento_entero,&n_1) == 1,
  "El elemento '10' se encuentra en la primera posicion de la lista"); 
    pa2m_afirmar(lista_con_cada_elemento(una_lista,buscar_elemento_entero,&n_2) == 2,
  "El elemento '20' se encuentra en la segunda posicion de la lista"); 
    pa2m_afirmar(lista_con_cada_elemento(una_lista,buscar_elemento_entero,&n_3) == 3,
  "El elemento '30' se encuentra en la tercera posicion de la lista"); 
...
int main() {
  ...
  dadaunalistadetreselementos_alquererinsertarunelementoenunaposicioninexsitentealfinaldelalista_seinsertaenlaultimaposicion();
