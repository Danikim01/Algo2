...
bool recorrer_hasta_4(void* elemento, void* extra){
    extra=extra; //para que no se queje el compilador, gracias -Werror -Wall
    if(elemento){
        if(((cosa*)elemento)->clave == 4)
            return true;
    }
    return false;
}

bool recorrer_hasta_5(void* elemento, void* extra){
    extra=extra; //para que no se queje el compilador, gracias -Werror -Wall
    if(elemento){
        if(((cosa*)elemento)->clave == 5)
            return true;
...
bool recorrer_hasta_15(void* elemento, void* extra){
    extra=extra; //para que no se queje el compilador, gracias -Werror -Wall
    if(elemento){
...
bool recorrer_hasta_3(void* elemento, void* extra){
    extra=extra; //para que no se queje el compilador, gracias -Werror -Wall
    if(elemento){
...
bool recorrer_hasta_todo(void* elemento, void* extra){
    extra=extra; //para que no se queje el compilador, gracias -Werror -Wall
    return false;
}
...
int main(){
    ...
    printf("\nCantidad elementos preorden %i",abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, recorrer_hasta_todo,NULL));
    printf("\nCantidad elementos preorden hasta encontrar el 5 es %i",abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, recorrer_hasta_5,NULL));
    printf("\nCantidad elementos preorden hasta encontrar el 4 es %i",abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, recorrer_hasta_4,NULL));
    printf("\nCantidad elementos preorden hasta encontrar el 3 es %i",abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, recorrer_hasta_3,NULL));
    ...
    printf("\n");
    printf("\nCantidad elementos POSTORDEN hasta encontrar el 5 es %i",abb_con_cada_elemento(arbol, ABB_RECORRER_POSTORDEN, recorrer_hasta_5,NULL));
...
/*
    int cinco = 0;
    printf("\nCantidad elementos preorden hasta encontrar el 0 es %i",abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, recorrer_hasta_5,&cinco));
*/

    printf("\nRecorrido postorden hasta encontrar el 5: ");    
    ...
    acumulador=0;
    printf("\nRecorrido preorden acumulando los valores: ");    
    ...
    size_t iterados = 0;
    printf("\nRecorrido inorden hasta encontrar el 5: ");    
    iterados = abb_con_cada_elemento(arbol, ABB_RECORRER_INORDEN, mostrar_hasta_5, NULL);
    printf("iterados: %d\n", iterados);
    printf("\n");
    
    printf("Recorrido preorden hasta encontrar el 5: ");    
    iterados = abb_con_cada_elemento(arbol, ABB_RECORRER_PREORDEN, mostrar_hasta_5, NULL);
    printf("iterados: %d\n", iterados);
    printf("\n");

    printf("Recorrido postorden hasta encontrar el 5: ");    
    iterados = abb_con_cada_elemento(arbol, ABB_RECORRER_POSTORDEN, mostrar_hasta_5, NULL);
    printf("iterados: %d\n", iterados);
    printf("\n");
