...
void dadoUnArchivoVacio_NoSeAgreganPokemonAlHospital(){
    ...
    bool retorno = hospital_leer_archivo(h, "ejemplos/archivo_vacio.hospital");
    pa2m_afirmar(retorno, "Puedo leer un archivo vacío");
...
void dadoUnArchivoConUnEntrenador_SeAgregaElEntrenadorYSusPokemonAlHospital(){
    ...
    bool retorno = hospital_leer_archivo(h, "ejemplos/un_entrenador.hospital");
    pa2m_afirmar(retorno, "Puedo leer un archivo con un entrenador");
...
void prueba_escritura_archivos(){
    hospital_t* h=hospital_crear();

    pa2m_afirmar(hospital_leer_archivo(h, "ejemplos/varios_entrenadores.hospital"), "Puedo leer un archivo con varios entrenadores");
    pa2m_afirmar(hospital_guardar_archivo(h,"archivo_escritura.txt"),"SE CREA UN ARCHIVO POR LO MENOS");
